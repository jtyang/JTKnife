...
package com.android.jtknife.core.widgets.pullrefresh.ext;
...
import com.android.jtknife.core.widgets.pullrefresh.IRefreshStatus;

import static android.R.attr.fraction;

public class CircleProgressBar extends android.support.v7.widget.AppCompatImageView implements IRefreshStatus {
...
//    }
    ...
    public void pullProgress(float pullDistance, float pullProgress) {
        if (!mHasTriggeredRefresh) {
            mProgressDrawable.setProgressRotation(pullProgress);
        }
    }
